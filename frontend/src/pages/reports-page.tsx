    ...
    <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-4 xl:grid-cols-5">
              ...
              <div className="space-y-2">
                ...
                <Select value={employeeStatus} onValueChange={setEmployeeStatus}>
                  <SelectTrigger id="report-employees-status">
              ...
              <div className="space-y-2">
                ...
                <Select value={employeeSiteId} onValueChange={setEmployeeSiteId}>
                  <SelectTrigger id="report-employees-site">
              ...
              <div className="space-y-2">
                ...
                <Select value={employeeAreaId} onValueChange={setEmployeeAreaId}>
                  <SelectTrigger id="report-employees-area">
              ...
              <div className="space-y-2">
                ...
                <Select value={employeePositionId} onValueChange={setEmployeePositionId}>
                  <SelectTrigger id="report-employees-position">
            ...
            <div className="grid gap-4 xl:grid-cols-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={attendanceStatus} onValueChange={setAttendanceStatus}>
                  <SelectTrigger id="report-attendance-status">
                    <SelectValue placeholder="Estado" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ALL">Todos</SelectItem>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Select value={attendanceEmployeeId} onValueChange={setAttendanceEmployeeId}>
                      <SelectTrigger id="report-attendance-employee">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={attendanceSiteId} onValueChange={setAttendanceSiteId}>
                      <SelectTrigger id="report-attendance-site">
                        <SelectValue placeholder="Sede" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="ALL">Todas</SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={attendanceAreaId} onValueChange={setAttendanceAreaId}>
                      <SelectTrigger id="report-attendance-area">
                        <SelectValue placeholder="Área" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="ALL">Todas</SelectItem>
            ...
            <div className="grid gap-4 xl:grid-cols-5">
              ...
              <div className="space-y-2">
                ...
                <Select value={requestStatus} onValueChange={setRequestStatus}>
                  <SelectTrigger id="report-requests-status">
                    <SelectValue placeholder="Estado" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ALL">Todos</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select value={requestGroup} onValueChange={setRequestGroup}>
                  <SelectTrigger id="report-requests-group">
              ...
              {!isManagerOnly ? (
                <div className="space-y-2">
                  ...
                  <Select value={requestEmployeeId} onValueChange={setRequestEmployeeId}>
                    <SelectTrigger id="report-requests-employee">
                      <SelectValue placeholder="Empleado" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="ALL">Todos</SelectItem>
            ...
            <div className="grid gap-4 xl:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Select value={contractSiteId} onValueChange={setContractSiteId}>
                  <SelectTrigger id="report-contracts-site">
                    <SelectValue placeholder="Sede" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ALL">Todas</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select value={contractAreaId} onValueChange={setContractAreaId}>
                  <SelectTrigger id="report-contracts-area">
                    <SelectValue placeholder="Área" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="ALL">Todas</SelectItem>
      ...
      <Card className="rounded-3xl">
        ...
        <CardContent className="flex flex-wrap gap-2">
          {roles.map((role) => (
            <Button key={role} type="button" variant="outline" size="sm" disabled>
              <FileSpreadsheet />
              {getRoleLabel(role)}
            </Button>
          ))}
